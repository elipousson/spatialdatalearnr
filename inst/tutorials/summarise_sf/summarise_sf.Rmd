...
We also need to convert `storms` from a data frame into a sf object. Using column names for longitude and latitude from the summary, fill in the missing coords parameter for `sf::st_as_sf()`:
